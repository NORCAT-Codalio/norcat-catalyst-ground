...
export const newsItems = [
  {
    id: 'venture-north-pitch-2026-applications-open',
    title: 'Applications Now Open for Venture North PITCH 2026',
    date: 'June 2, 2026',
    excerpt: 'Venture North PITCH is back and looking for innovative ideas backed by bold founders to take the stage.',
    category: 'Event',
    icon: Rocket,
    fullContent: `SUDBURY, ON – June 2, 2026 – NORCAT and Northern Ontario Angels (NOA) are proud to announce the return of Venture North PITCH, set to take place on Thursday, October 1, 2026, at Collège Boréal in Greater Sudbury, Ontario.\n\nNow in its third iteration, Venture North PITCH continues to serve as a catalyst for emerging small and medium enterprises (SMEs) looking to scale within Northern Ontario's innovation ecosystem. Through the strategic partnership between NORCAT and NOA, the event connects diverse, tech-enabled SMEs with early-stage funding, talent, and resources unique to Greater Sudbury and Northern Ontario.\n\nApplications are now open for entrepreneurs interested in pitching at Venture North PITCH 2026.\n\nThis year, $15,000 CAD in cash prizes will be awarded, including the $10,000 Judges' Choice Award, sponsored by CircuitIQ, and the $5,000 Peter Dal Bianco Award, sponsored by PLAN A and StaffStat.\n\nApplications will be accepted from June 2, 2026, until July 6, 2026, at 11:59 PM EST.\n\nEntrepreneurs are encouraged to visit [https://norcat.org/venture-north-pitch-2026/pitch.html](https://norcat.org/venture-north-pitch-2026/pitch.html) to apply and learn more about eligibility requirements and entry guidelines.\n\nVenture North PITCH is a platform for Northern Ontario's most promising entrepreneurs to showcase bold ideas, build meaningful connections with accredited angel investors and industry leaders, and gain the exposure, mentorship, and support needed to accelerate business growth across the region.\n\n"NOA has always been about establishing the capital needed to bring bold ideas to life and provide a launchpad for the talent right here in our backyard," says Ian Lane, Executive Director at Northern Ontario Angels. "As the region's premier angel investment group, we see Venture North PITCH 2026 as a vital marker of the collective success we are gaining. By bridging the gap between ambitious entrepreneurs and strategic investors, we are ensuring that Northern Ontario remains a leader in innovation."\n\nVenture North PITCH has long served as a launchpad for early-stage companies, and its impact is visible in the success of its alumni. Past winners and finalists, including Luke Begley (CircuitIQ), Dr. Chao Yu (LoopX), and Rafaela Andrade (Myomar Molecular) are now firmly established in the region, utilizing local assets like the Health Sciences North (HSN) labs and the NORCAT Underground Centre to drive global solutions in AI, robotics, and MedTech.\n\n"What makes Venture North PITCH so powerful is the ripple effect it creates across our region. Through our continued collaboration with NOA, we're not just supporting individual founders, we're strengthening an ecosystem where ideas, capital, and talent converge to drive lasting economic impact" says Brendan Skiffington, Manager of NORCAT Innovation. "NORCAT is proud to help build that foundation, and we're excited to see what this next cohort of Northern entrepreneurs will accomplish in 2026 and beyond."\n\nFor full details on entry guidelines, partnership opportunities, and ticket information, please visit: [https://norcat.org/venture-north-pitch-2026/index.html](https://norcat.org/venture-north-pitch-2026/index.html)`,
    aboutSections: [
      { title: 'About NORCAT Innovation', text: 'NORCAT is a global leader in skilled labor training, development, and innovation services. As Sudbury’s Regional Innovation Centre, NORCAT Innovation focuses on supporting early-stage tech startups and their founders. We provide access to essential resources and connect them with the networks necessary to start, grow, and scale their ventures.' },
      { title: 'About Northern Ontario Angels', text: 'Northern Ontario Angels (NOA) stands as the sole Accredited Angel Organization in Northern Ontario. As a proud member of both the National Angel Capital Organization (NACO) and Angel Investors Ontario (AIO), NOA connects accredited angel investors to Northern Ontario entrepreneurs looking for growth capital and investments.' },
    ],
  },
  {
  ...
  return (
    <Layout>
      <div style={{ background: NAVY, color: 'white', fontFamily: FONT }}>
        ...
        {/* ───── Newsletter CTA (homepage-style glass card) ───── */}
        <section className="relative overflow-hidden py-24 md:py-36 lg:py-44" style={{ background: PAPER }}>
            ...
            <div className="relative rounded-[2rem] md:rounded-[2.5rem] px-6 py-14 md:px-16 md:py-20 text-center overflow-hidden"
              ...
              <div className="relative">
                <span className="inline-flex items-center gap-2 px-4 py-1.5 mb-7 rounded-full text-xs font-bold uppercase tracking-[0.2em]"
                      style={{ color: BLUE, background: 'rgba(0,61,166,0.08)', border: '1px solid rgba(0,61,166,0.15)' }}>
                  Stay in the Loop
                </span>
                <h2 className="font-black uppercase leading-[0.92] tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6"
                    style={{ fontFamily: FONT, color: BLUE, letterSpacing: '-0.03em' }}>
                ...
                <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <button
                    type="submit"
                    className="group inline-flex items-center justify-center gap-2 text-base font-bold px-6 py-3 rounded-full text-white transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]"
