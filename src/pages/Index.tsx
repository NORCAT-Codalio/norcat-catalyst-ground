...
const testimonials = [
  {
    quote:
      "NORCAT Innovation gave us the credibility and connections we needed to close our Series A. Their underground testing facility was a game-changer for our mining automation technology.",
    author: "Sarah Chen",
    role: "CEO",
  ...
  {
    quote:
      "The mentorship here is world-class. They understand what it takes to build hardware companies and connected us with exactly the right investors.",
  ...
  {
    quote:
      "From IAP funding to investor introductions, NORCAT Innovation accelerated our growth by at least 18 months. This is where serious founders come to build.",
          ...
          <div className="max-w-4xl">
            ...
            <ScrollReveal delay={200}>
              <p className="body-lg text-slate-300 mb-8 max-w-2xl">
                Ontario's hub for emerging mining technology and tech-enabled startups. We help founders start, grow,
                and scale with world-class mentorship, capital access, and the only underground testing facility of its
                kind.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="btn-hero-outline border-slate-400 text-slate-200 hover:bg-slate-800 hover:text-slate-50"
                >
          ...
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="headline-lg mb-6">
                Everything Founders Need to <span className="text-gradient-teal">Scale</span>
              </h2>
              <p className="body-lg">
                From early-stage mentorship to growth capital, we provide the complete support system for tech-enabled,
                IP-driven startups.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <ScrollReveal direction="left">
              <div>
                ...
                <h2 className="headline-lg text-slate-50 mb-6">The NORCAT Underground Centre</h2>
                <p className="body-lg text-slate-300 mb-6">
                  A real, active mine where startups can test, validate, and demonstrate mining technology in
                  operational conditions. This globally unique asset gives your technology the credibility it needs to
            ...
            <ScrollReveal direction="right">
              <div className="relative">
                <img src={miningTechImage} alt="Mining technology demonstration" className="rounded-2xl shadow-2xl" />
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <ScrollReveal direction="left">
              <div className="relative">
                <img src={foundersImage} alt="Startup founders collaborating" className="rounded-2xl shadow-2xl" />
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right">
              <div>
                ...
                <h2 className="headline-lg mb-6">
                  Built for Ambitious <span className="text-gradient-teal">Founders</span>
                </h2>
                <p className="body-lg mb-6">
                  We work with early-stage to scaling tech-enabled, IP-driven startups. Whether you're building mining
                  technology, cleantech, industrial IoT, or critical minerals solutions—if you're solving hard problems,
                  you belong here.
                </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="headline-lg mb-6">
                The Heart of <span className="text-gradient-teal">Mining Innovation</span>
              </h2>
              <p className="body-lg">
                Greater Sudbury is home to the world's largest concentration of mining expertise, research institutions,
                and industry partners. It's the ideal place to build and scale mining technology.
              </p>
            </div>
          </ScrollReveal>
            ...
            {[
              {
                ...
                description:
                  "Direct connections to major mining companies, OEMs, and global industry leaders actively seeking new technology.",
              },
              {
                number: "02",
                title: "Research Ecosystem",
                description:
                  "World-class research institutions including Laurentian University, MIRARCO, and CEMI driving innovation.",
              },
              {
                number: "03",
                title: "Talent Pipeline",
                description:
                  "Access to skilled engineers, geologists, and technologists with deep mining industry expertise.",
              },
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="headline-lg mb-6">
                What Founders Are <span className="text-gradient-teal">Saying</span>
              </h2>
            </div>
          </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <ScrollReveal direction="left">
              <div>
                ...
                <h2 className="headline-lg text-slate-50 mb-6">Where the Ecosystem Connects</h2>
                <p className="body-lg text-slate-300 mb-8">
                  Our flagship events bring together founders, investors, industry leaders, and innovation partners.
                  From Mining Transformed to Venture North PITCH, these are where deals get done.
                </p>
            ...
            <ScrollReveal direction="right">
              <div className="relative">
                <img src={pitchEventImage} alt="Venture North PITCH event" className="rounded-2xl shadow-2xl" />
              </div>
            </ScrollReveal>
          </div>
        </div>
