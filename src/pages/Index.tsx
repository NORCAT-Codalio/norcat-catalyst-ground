                ...
                <div>
                  ...
                  <Link 
                    ...
                    style={{
                      ...
                      boxShadow: '0 6px 24px -4px hsla(155, 40%, 40%, 0.2), 0 2px 8px -2px hsla(155, 30%, 50%, 0.15), inset 0 1px 1px hsla(150, 50%, 95%, 0.4), inset 0 8px 16px -8px hsla(0, 0%, 100%, 0.2)',
                      color: 'hsl(155, 50%, 18%)',
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(145deg, hsla(150, 22%, 78%, 0.65) 0%, hsla(155, 28%, 68%, 0.55) 100%)';
                      e.currentTarget.style.boxShadow = '0 8px 32px -4px hsla(155, 40%, 40%, 0.3), 0 4px 12px -2px hsla(155, 30%, 50%, 0.2), inset 0 1px 1px hsla(150, 50%, 95%, 0.5), inset 0 8px 16px -8px hsla(0, 0%, 100%, 0.25)';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(145deg, hsla(150, 20%, 75%, 0.55) 0%, hsla(155, 25%, 65%, 0.45) 100%)';
                      e.currentTarget.style.boxShadow = '0 6px 24px -4px hsla(155, 40%, 40%, 0.2), 0 2px 8px -2px hsla(155, 30%, 50%, 0.15), inset 0 1px 1px hsla(150, 50%, 95%, 0.4), inset 0 8px 16px -8px hsla(0, 0%, 100%, 0.2)';
                    }}
                  >
