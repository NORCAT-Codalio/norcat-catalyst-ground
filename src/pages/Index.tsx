            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <ScrollReveal>
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl leading-[1.1] mb-6" style={{ color: 'hsl(220, 15%, 20%)', fontFamily: "'Space Grotesk', sans-serif", fontWeight: 500 }}>
                    A Thriving <span className="text-4xl md:text-5xl lg:text-6xl" style={{ color: 'hsl(168, 100%, 28%)', fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontStyle: 'italic' }}>Innovation Ecosystem</span>
                  </h2>
