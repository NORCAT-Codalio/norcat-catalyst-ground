...
const upcomingEvents: Event[] = [
  ...
  {
    id: 'ai-collective-series-2026',
    title: 'AI Collective Workshops (6-Part Series)',
    date: 'August 27, 2026',
    time: 'TBD',
    location: 'Hybrid Event',
    type: 'Workshop',
    description: 'Six-month series exploring practical AI for founders and operators. Kicks off Aug 27, 2026 and repeats the last Thursday of every month for six months.',
    featured: false,
    registrationOpen: false,
    isVirtual: false,
    isHybrid: true,
    host: 'NORCAT Innovation',
    highlight: '6-part series',
  },
  {
