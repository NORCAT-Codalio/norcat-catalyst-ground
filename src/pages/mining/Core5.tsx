...
import { ArrowRight, Atom, Check } from 'lucide-react';
    ...
    <Layout>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-32 pb-20">
          <ScrollReveal>
            ...
            <p className="body-xl text-white/70 max-w-2xl mb-10">
              Accelerating the commercialization of critical minerals technologies 
              and building Canada's competitive advantage in the global supply chain.
            </p>
      ...
      <section className="section-padding bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <ScrollReveal>
              <h2 className="headline-lg mb-8">Focus Areas</h2>
              <ul className="space-y-4 mb-12">
                {[
                  ...
                  'ESG and sustainability innovation',
                ].map((item, i) => (
      ...
      <section className="section-padding bg-gray-900">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <ScrollReveal>
            <h2 className="headline-lg text-white mb-6">Join Core5</h2>
            <Button asChild className="btn-primary-lg">
              <Link to="/apply">
                Apply Now
                <ArrowRight className="w-5 h-5" />
