        ...
        <section className="relative overflow-hidden flex items-center py-16 md:py-24">
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
            <div className="max-w-4xl">
              ...
              >
                Core5 is a pan-Northern Ontario initiative supporting Ontario SMEs in developing EV
                technologies across the value chain — from critical minerals extraction to EV technology
                manufacturing.
              </p>
