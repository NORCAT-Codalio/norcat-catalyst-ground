...
export default function Home2() {
  ...
  const featuredPrograms = [
    ...
    },
    {
      ...
      href: '/mining/core5',
      partners: [
        { logo: ovinLogoAsset.url, name: 'Ontario Vehicle Innovation Network' },
        { logo: ontarioLogoInlineAsset, name: 'Government of Ontario' },
      ],
    },
  ];
    ...
    <Layout>
      <div style={{ background: NAVY, color: 'white', fontFamily: "'Open Sans', sans-serif" }}>
          ...
          <div className="relative w-full flex-1 flex flex-col items-stretch justify-center">
            <div className="flex flex-col justify-center px-5 sm:px-6 md:px-10 lg:pl-[max(2.5rem,calc((100vw-96rem)/2+2.5rem))] lg:pr-[max(2.5rem,calc((100vw-96rem)/2+2.5rem))] pt-8 pb-8 md:pt-12 md:pb-12">
                ...
                <div className="mt-9 flex flex-col sm:flex-row gap-4">
                  <Link to="/apply"
                        className="inline-flex items-center gap-2 px-5 py-2 xl:px-7 xl:py-3 rounded-full font-bold transition-transform hover:scale-[1.02]"
                        style={{ fontFamily: FONT, background: 'rgba(0, 179, 152, 0.8)', color: 'white', fontSize: 'clamp(0.875rem, 0.3vw + 0.78rem, 1.125rem)' }}>
                    Apply to NORCAT Innovation
                  </Link>
                  <Link to="/about"
                        className="inline-flex items-center gap-2 px-5 py-2 xl:px-7 xl:py-3 rounded-full font-bold transition-transform hover:scale-[1.02]"
                        style={{ fontFamily: FONT, background: 'rgba(255,255,255,0.85)', color: NAVY, border: '1px solid #001A4D', fontSize: 'clamp(0.875rem, 0.3vw + 0.78rem, 1.125rem)' }}>
                    Learn More
                  </Link>
                </div>
        ...
        <div className="relative overflow-hidden" style={{ background: '#F2F3F6' }}>
          <div className="absolute inset-0 pointer-events-none" style={{
            backgroundImage: `radial-gradient(ellipse at bottom right, rgba(0,179,152,0.14), transparent 50%), radial-gradient(ellipse at bottom left, rgba(0,179,152,0.09), transparent 45%), radial-gradient(ellipse at top left, rgba(47,111,214,0.08), transparent 55%)`,
          }} />
        <section className="relative z-10 py-10 md:py-14" style={{ color: NAVY }}>
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase leading-[0.95] tracking-tight mb-4"
              ...
              <span style={{ color: NAVY }}>Featured </span>
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
            ...
            <div className="relative rounded-2xl overflow-hidden p-8 md:p-10 lg:p-12 flex flex-col lg:flex-row items-center lg:items-center gap-8 lg:gap-8"
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 flex-shrink-0">
                <Link to="/programs"
                      className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-bold transition-transform hover:scale-[1.02]"
