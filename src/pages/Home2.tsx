  ...
  return (
    <Layout>
      <div style={{ background: NAVY, color: 'white', fontFamily: "'Open Sans', sans-serif" }}>
        ...
        {/* ───── PROGRAM HIGHLIGHTS ───── */}
        <section className="py-20 md:py-32 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #003da5 0%, #001a4d 100%)' }}>
          <div className="absolute inset-0 pointer-events-none" style={{
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 md:mb-16">
              ...
              <Link to="/programs/venture-growth-services"
                    className="inline-flex items-center gap-2 pl-5 pr-2 py-2 rounded-full text-sm font-bold transition-transform hover:scale-[1.02] self-start md:self-end"
        ...
        <section className="py-20 md:py-32 relative overflow-hidden" style={{ background: 'white' }}>
          <div className="relative mx-auto w-full max-w-4xl px-5 sm:px-6 md:px-10 text-center">
            ...
            <Link to="/apply"
                  className="inline-flex items-center gap-2 pl-5 pr-2 py-2 rounded-full text-sm font-bold transition-transform hover:scale-[1.02]"
                  style={{ fontFamily: FONT, background: 'rgba(0,179,152,0.2)', color: 'white', border: '1px solid rgba(0,179,152,0.4)' }}>
