...
const mentors = [
  ...
  { name: 'Peter Dal Bianco', image: peterDalBiancoImg, tags: ['Branding', 'Franchising'], bio: "Peter launched his Sudbury business career in 1975, helping take National Video public on Nasdaq and evolving Bianco's into a top recognized Northern brand. As a dedicated NORCAT mentor, he leverages his branding and franchising expertise to coach clients. Through Bianco's Management Consulting Group (BMCG) and as a Venture Partner in the Axion Fund, Peter has helped raise millions in startup capital, recently establishing the Axion North Initiative. He is a two-time Entrepreneur of the Year recipient for both Northern Ontario Business and Bell Business Excellence. In honour of his enduring commitment to entrepreneurship and innovation, the Venture North PITCH People's Choice Award has been officially renamed the Peter Dal Bianco Award, cementing his legacy at the upcoming October 1st showcase at Collège Boréal.", expertfile: 'http://expertfile.com/experts/peter.dalbianco' },
