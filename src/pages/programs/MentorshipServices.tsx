...
import gideonUcheharaImg from '@/assets/mentors/gideon-uchehara.jpg.asset.json';
...
const mentors = [
  ...
  { name: 'Cathy Nadjiwon', image: cathyNadjiwonImg, tags: ['Business Development', 'Strategic Planning'], bio: 'Cathy Nadjiwon is a seasoned geomatics professional and product innovator specializing in the mineral exploration and mining sectors. Currently the President of UnderCover Innovations Inc., she brings extensive expertise in strategic business planning, startups, and hardware product development. Previously, Cathy managed business development for CAE Mining Canada and successfully co-owned two spatial application and GIS companies. A trailblazer in Northern Ontario business, she was recognized as the first-ever Entrepreneur of the Year (1-50 Employees) by the Greater Sudbury Chamber of Commerce and served as the first female Treasurer of the Ontario Trillium Foundation. Cathy leverages decades of leadership to actively guide emerging founders through complex commercialization.', expertfile: 'http://expertfile.com/experts/cathy.nadjiwon' },
  { name: 'Chad Pallopson', image: chadPallopsonImg, tags: ['Finance', 'US Markets'], bio: 'Chad Pallopson brings over 20 years of extensive capital markets and executive leadership experience, having navigated equity trading and valuation at top Wall Street firms including J.P. Morgan, Lazard, and SVB Leerink. Transitioning from deep financial roots to venture investing and operational leadership, he currently serves as the Chief Operating Officer at Genetics Adviser, an innovative digital genomics and health technology company based in Toronto.\n\nAs a dedicated champion of Canada\'s innovation ecosystem, Chad is a Venture Partner at both the Adrenaline Fund and the Archangel Network of Funds. Further extending his impact across the region, he operates as a strategic Consultant for the Northern Ontario Angels, representing the Parry Sound and Muskoka districts. Having previously served on the board of IRegained Inc. until late 2024, Chad now leverages his Wharton education and profound venture expertise to actively guide emerging founders as a NORCAT mentor.', videoUrl: 'https://www.youtube.com/embed/JxpkbIh6Tmg', expertfile: 'http://expertfile.com/experts/chad.pallopson' },
  { name: 'David Pasieka', image: davidPasiekaImg, tags: ['M&A', 'Cybersecurity'], bio: 'David Pasieka brings over 30 years of C-Suite leadership spanning the technology, renewable power, and utility sectors. Currently an Executive Partner at Calera Capital and the founder of Cedarvue advisory, David specializes in corporate turnarounds, M&A, and go-to-market strategies. During his tenure as President, COO, and Chief Transformation Officer at Algonquin Power & Utilities Corp., he spearheaded over 40 major utility acquisitions across North America. He has also driven significant impact within the Canadian innovation ecosystem, formerly serving as an Entrepreneur-In-Residence at MaRS Discovery District where he guided over 240 cleantech startups through critical funding and scaling phases.\n\nActive in major regional infrastructure and governance, David was recently appointed in 2026 to lead key business initiatives for the Energy Corridor First Nations (ECFN) consortium on the Barrie–Sudbury Transmission Line project. He holds an MBA from the Schulich School of Business, a BSc from the University of Waterloo, and advanced executive certifications in Coaching (Royal Roads), Sustainability (Oxford), and Cybersecurity (Harvard). A dedicated NORCAT mentor and board member for several organizations, including Oakville Hydro, David leverages his extensive expertise in risk management, capital formation, and commercialization to aggressively scale emerging ventures.', expertfile: 'http://expertfile.com/experts/david.pasieka' },
  { name: 'Sheri Tomchick', image: sheriTomchickImg, tags: ['Leadership', 'Scalability'], bio: 'Sheri Tomchick is a pioneering healthcare entrepreneur, technology founder, and nursing professional who has fundamentally transformed healthcare shift-scheduling logistics across Ontario. Driven by a mission to solve critical staffing shortages in the vulnerable senior care sector, Sheri founded Plan A Long Term Care Staffing and Recruitment in 2011. To eliminate the hundreds of manual hours spent calling rosters to fill vacant shifts, she conceptualized and launched StaffStat, Inc. in 2014—an automated software platform that bypasses the middleman by directly broadcasting available shifts to healthcare workers via text, email, and phone.\n\nSheri\'s breakthrough came in May 2014 when she won the People\'s Choice Award at NORCAT\'s inaugural PITCH competition, securing the vital funding and development services necessary to commercialize StaffStat beyond an in-house tool. Under her leadership, the software expanded provincially across dozens of long-term care and community support facilities, earning StaffStat the "Innovator of the Year" award at the 2016 This is Long-Term Care provincial conference. A Seneca College nursing alumna, Sheri has been honored as the Greater Sudbury Chamber of Commerce Entrepreneur of the Year and the Influential Woman of Northern Ontario Entrepreneur of the Year. As a dedicated mentor and active ecosystem contributor, she regularly shares her deep expertise in scaling, operations, and business strategy with emerging founders through NORCAT\'s LAUNCH program.', videoUrl: 'https://www.youtube.com/embed/-tf6MIIZw5E', expertfile: 'http://expertfile.com/experts/sheri.tomchick' },
  { name: 'Gideon Uchehara, PhD', image: gideonUcheharaImg.url, tags: ['AI/ML', 'Quantum'], bio: 'Gideon Uchehara, PhD, is a premier quantum computing researcher and AI adoption mentor specializing in translating frontier-tech complexity into strategic commercial opportunities. He completed his PhD in Electrical and Computer Engineering at the University of British Columbia in late 2025, where his doctoral work focused heavily on quantum machine learning, circuit cut optimization, and scalable qubit reuse. Building on his cutting-edge academic work, Gideon secured a research deployment at PsiQuantum, a global frontrunner in fault-tolerant quantum computing.\n\nA powerful advocate for structural inclusion in deep technology, Gideon is the founder of Blacks in Quantum. This foundational network connects Black scholars with academic and corporate avenues, bridging systemic gaps in quantum science. His comprehensive engineering pedigree also features a Master\'s degree from McGill University and technical experience refining hydrogen fuel cell systems at Ballard Power Systems. As a NORCAT mentor, Gideon leverages his deep mathematical and architectural fluency to guide companies safely through complex AI integration and advanced technology adoption pipelines.', videoUrl: 'https://www.youtube.com/embed/bLjGYJQLf2c', expertfile: 'http://expertfile.com/experts/gideon.uchehara' },
  { name: 'Barb Ward-Dagnon', image: barbWardDagnonImg, tags: ['Clinical Trials', 'Regulatory Compliance'], bio: 'Barb Ward-Dagnon successfully bridges frontline healthcare delivery with global corporate execution. A Registered Practical Nurse (RPN) and Certified Clinical Research Professional (CCRP), Barb integrated her dual background in nursing and business administration to found Sudbury-based Medicor Research Inc. Her objective was to connect top-tier global pharmaceutical companies with unique patient populations in Northern Ontario, expanding local access to cutting-edge clinical trials.\n\nWithin three years of its launch, Medicor achieved international recognition for clinical trial precision, establishing strict benchmarks for quality and compliance among North American research sites. Under her leadership, the firm has contributed to the development of more than 30 vaccines, earning exceptional performance feedback from the US Food and Drug Administration (FDA).\n\nThrough strategic branding and operational excellence, Barb has built a robust network of over 60 pharmaceutical and academic clients. As a dedicated NORCAT mentor, she frequently shares her commercialization and regulatory expertise to guide emerging health-tech and life science innovators.', expertfile: 'http://expertfile.com/experts/barb.ward-dagnon' },
];
    ...
    <Layout>
      <div style={{ background: NAVY, color: 'white', fontFamily: FONT }}>
        ...
        <FinalCTA
          ...
          title="Ready to get"
          titleAccent="matched?"
          body="Join our Venture Mentoring Service and get matched with experienced mentors who can help you navigate the challenges of building a successful company."
