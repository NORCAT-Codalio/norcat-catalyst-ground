    ...
    <Layout>
      <div style={{ background: NAVY, color: 'white', fontFamily: FONT }}>
        ...
        <section className="pb-16 md:pb-24" style={{ background: BLUE, color: 'white' }}>
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
            <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-10 p-8 md:p-10 rounded-2xl shadow-lg mb-[-80px] md:mb-[-112px] relative z-10" style={{ background: 'white', border: '1px solid rgba(0,26,77,0.08)' }}>
