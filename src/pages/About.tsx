          ...
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={s.label} className="pl-4" style={{ borderLeft: `2px solid ${NAVY}` }}>
                  <p className="font-black text-3xl md:text-4xl" style={{ fontFamily: FONT, color: TEAL }}>{s.number}</p>
              ...
              <div className="relative">
                ...
                <ul className="relative">
                  {[
                    ...
                    { year: '2017', title: 'Underground Centre Expansion', desc: 'Joint public funding helps NORCAT overhaul the Underground Centre, creating live testing labs for international technology builders.', image: norcatBuilding.url },
                            ...
                            >
                              <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  {event.cta && (
                                    <div className="pt-4">
                                      <Link to={event.cta.href} className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold" style={{ background: 'rgba(0, 179, 152, 0.8)', color: 'white', fontFamily: FONT }}>
                                        {event.cta.label}
