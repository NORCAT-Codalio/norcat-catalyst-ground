  ...
  return (
    <Layout>
      <div>
        ...
        {/* ===== HERO SECTION — TEAL ===== */}
        <section className="relative pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden" style={{ background: 'linear-gradient(180deg, hsl(168 100% 28%) 0%, hsl(168 80% 22%) 60%, hsl(170 90% 20%) 100%)' }}>
          {/* Ambient gradient orbs */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 mt-20">
            <ScrollReveal delay={300}>
              <div className="flex flex-wrap gap-6 md:gap-8">
                {stats.map((stat) => (
                  <div key={stat.label} className="rounded-2xl px-8 py-6 flex-1 min-w-[180px]" style={{ background: 'hsla(0, 0%, 100%, 0.1)', border: '0.5px solid hsla(0, 0%, 100%, 0.2)', backdropFilter: 'blur(12px)' }}>
                    <div className="text-4xl md:text-5xl font-black text-white tracking-tight">
                      {stat.number}
                    </div>
                    <div className="text-[10px] font-semibold tracking-[0.2em] uppercase mt-2 text-white/50">
                      {stat.label}
                    </div>
                  </div>
                ))}
