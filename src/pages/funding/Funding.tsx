...
const industryTracks = [
  {
    ...
    audience: 'For Ontario mining, industrial, and tough-tech companies',
    ...
    bullets: ['Non-dilutive project funding', 'Real-world testing in the Underground Centre', 'Direct pathways to mining OEMs'],
    href: '/mining/critical-industrial-tech',
  },
  {
    icon: Layers,
    name: 'Core5',
    audience: 'For BEV / EV ventures across Northern Ontario',
    description: 'The OVIN Northern Regional Technology Development Site supporting SMEs across the full EV value chain.',
    bullets: ['Startup & SME funding support', 'Access to R&D and testing facilities', 'Buyer / builder matchmaking'],
    href: '/mining/core5',
  },
];
